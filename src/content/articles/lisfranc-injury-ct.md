...
<div class="reference-card__group">
<p class="reference-card__label">When films are normal</p>
<ul>
<li>Swelling out of proportion plus plantar ecchymosis: pursue it</li>
<li>Weight-bearing views if tolerated, CT if not</li>
<li>MRI for the ligament when CT is equivocal</li>
</ul>
</div>
</div>
