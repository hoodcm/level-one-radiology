...
<p class="reference-card__title">Closed-loop obstruction: the read</p>
<div class="reference-card__group">
<p class="reference-card__label">Look for</p>
<ul>
<li>Two transition points on one bowel segment</li>
<li>Converging mesenteric vessels (whirl or beak)</li>
<li>C-shaped or U-shaped loop on coronal reformats</li>
</ul>
</div>
<div class="reference-card__group">
<p class="reference-card__label">Signs of ischemia</p>
<ul>
<li>Reduced or absent wall enhancement (most specific)</li>
<li>Mesenteric haziness from venous congestion</li>
<li>High-density intraluminal contents (&gt;20 HU)</li>
</ul>
</div>
</div>
